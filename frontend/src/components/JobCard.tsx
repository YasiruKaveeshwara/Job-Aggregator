    ...
    >
      ...
      <div style={{ display: "flex", gap: 16, alignItems: "flex-start" }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          {/* Company & location */}
          <p style={{ fontSize: 13, color: "var(--text-secondary)", marginBottom: 10, display: "flex", alignItems: "center", gap: 6, flexWrap: "wrap" }}>
        ...
        {/* Actions */}
        <div style={{ flexShrink: 0, display: "flex", flexDirection: "column", gap: 8, alignItems: "stretch", minWidth: 108 }}>
          {isRemoved ? (
            <button
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <DetailRow label="Status">
              <span className={`badge badge-state-${job.application_state.toLowerCase()}`} style={{ display: "inline-flex" }}>
                ...
                {job.sources.map((s) => (
                  ...
                  >
                    ...
                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none" style={{ marginLeft: 2 }}>
                      <path d="M2 8L8 2M8 2H4M8 2v4" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </a>
                ))}
              </div>
