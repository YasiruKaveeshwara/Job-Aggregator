			...
			<div
				...
				<span
					style={{
						...
						borderRadius: "9999px",
						background:
							geminiConfigured === null ? "var(--slate-bg)"
							: geminiConfigured ? "var(--green-bg)"
							: "var(--amber-bg)",
						color:
							geminiConfigured === null ? "var(--text-muted)"
							: geminiConfigured ? "var(--green)"
							: "var(--amber)",
						border: `1px solid ${
							geminiConfigured === null ? "var(--border)"
							: geminiConfigured ? "var(--green-border)"
							: "var(--amber-border)"
						}`,
					}}>
					<span
						...
						<div style={{ position: "relative", flex: 1 }}>
							<input
								...
								style={{
									...
									fontSize: "13px",
									fontFamily:
										inputValue ? "ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace" : "inherit",
					...
					<div
						...
						<a
							...
							<svg width='10' height='10' viewBox='0 0 12 12' fill='none'>
								<path
									d='M3.5 2.5h5v5M8.5 2.5L3.5 7.5'
									stroke='currentColor'
									strokeWidth='1.5'
									strokeLinecap='round'
